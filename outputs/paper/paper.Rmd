...
Continuing my analysis into attack rates, the next aspect of the data I analyzed is how the frequency of each type of attack is changing over time. Figure \@ref(fig:attackevo) shows the number of each type of attack year over year since 2016. Here we see that the every type of attack increased in frequency in 2021, with exploits experiencing by far the greatest spike. 
